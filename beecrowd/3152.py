...
doubleAreaA = (ax1 * ay2 - ax2 * ay1) + (ax2 * ay3 - ax3 * ay2) + (ax3 * ay4 - ax4 * ay3) + (ax4 * ay1 - ax1 * ay4)
doubleAreaB = (bx1 * by2 - bx2 * by1) + (bx2 * by3 - bx3 * by2) + (bx3 * by4 - bx4 * by3) + (bx4 * by1 - bx1 * by4)
